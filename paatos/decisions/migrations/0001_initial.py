# -*- coding: utf-8 -*-
# Generated by Django 1.9.3 on 2016-03-05 13:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=255, verbose_name='Title for this action')),
        ...
        migrations.AddField(
            model_name='action',
            name='delegation',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='decisions.Post', verbose_name='If this decision was delegated, this field will be filled and refers to the post that made the decision'),
        ),
        migrations.AddField(
            model_name='action',
            name='event',
